...
(defun -nomis/ec-walk-and-overlay ()
  (save-excursion
    (cl-case -nomis/ec-electric-version
      (:v2
       (cond ((looking-at -nomis/ec-e/client-form-regexp)
              (-nomis/ec-overlay-site :client))
             ((looking-at -nomis/ec-e/server-form-regexp)
      ...
      (:v3
       (cond ((looking-at -nomis/ec-e/client-form-regexp)
             ...
             ((looking-at -nomis/ec-e/server-form-regexp)
              (-nomis/ec-overlay-site :server))
             ((looking-at -nomis/ec-e/fn-form-regexp)
              (-nomis/ec-overlay-site :neutral))
             ((looking-at -nomis/ec-dom/-form-regexp)
              (-nomis/ec-overlay-dom-xxxx))
             ((looking-at -nomis/ec-let-form-regexp)
              (-nomis/ec-overlay-let "let"))
             ((looking-at -nomis/ec-binding-form-regexp)
              (-nomis/ec-overlay-let "binding"))
             ((looking-at -nomis/ec-e/for-form-regexp)
              (-nomis/ec-overlay-let "e/for"))
             ((looking-at -nomis/ec-e/for-by-form-regexp)
