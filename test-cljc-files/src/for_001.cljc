...
(e/defn Foo1 [h]
  (e/server
    (e/for [local-1 (e/diff-by hash (.listFiles h))]
      (ElectricCall global-1 local-1)
      (host-call global-1 local-1))
